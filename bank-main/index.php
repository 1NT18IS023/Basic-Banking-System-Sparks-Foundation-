...
<nav class="navbar navbar-expand-lg py-1 navbar-dark bg-dark shadow-lg mb-3">
    ...
    <a href="#" class="navbar-brand">
      ...
      <!-- Logo Text -->
      <span class="text-uppercase font-weight-bold">THE SPARKS BANK</span>
    </a>
...
<form name="f1">  
<div class="row">  
    <img src="https://previews.123rf.com/images/birute/birute1912/birute191200129/134564320-madrid-spain-october-21-2019-the-bank-of-spain-banco-de-espana-on-street-calle-de-alcala-in-madrid-s.jpg" width="700px" height="300px" class="responsive mb-2">
...
<div class="row align-items-center justify-content-center mb-5">
  <div class="col-md-6">
    ...
    <img src="icon.png" class="d-md-block" height="150px" weight="150px" />
        <div class="card-body">
